...
Detail URL утверждённого audit-снимка теперь передаются в отдельный
review-gated semantic staging, описанный в `docs/SOURCE_STAGING.md`.
...
согласованием. Staging реализован, но автоматический publish в RAG
