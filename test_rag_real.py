#!/usr/bin/env python3
"""
Тестовый скрипт для проверки RAG системы с реальными эмбеддингами из LM Studio
"""
...
def test_rag_with_real_embeddings():
    ...
    print("🚀 Тестирование RAG системы с LM Studio...")
    
    # Создаем RAG систему с реальными эмбеддингами
    print("📋 Инициализирую RAG систему с LM Studio...")
